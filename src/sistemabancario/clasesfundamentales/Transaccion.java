...
public class Transaccion {
    ...
    public String toString(){
        ...
        if(prioridad) {
            ...
            sb.append("Razon de prioridad: ").append(descripcionPrioridad).append("\n");
        } else {
            sb.append("NO PRIORITARIO.\n");
        }
        sb.append("Hora de inicio de transacción: ").append(hora).append(" (hora militar).\n");
        sb.append("Hora de finalización: ").append(horaFinalización).append(" (hora militar)\n");
    ...
    public static void main(String[] args) {
        ...
        TiempoActual hora = new TiempoActual(13,54);
        Transaccion tran = new Transaccion(cl1, hora, 'C');
        tran.setPrioridad(true);
